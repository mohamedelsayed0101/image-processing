...
cv2.imshow('brightness_reduced_image', brightness_reduced_image)
cv2.imshow('contrast_increased_image', contrast_increased_image)
processed_iamge=reduce_brightness(contrast_increased_image)
cv2.imshow('processed_iamge',processed_iamge)
cv2.waitKey(0)
cv2.destroyAllWindows()

plot_histograms(image,processed_iamge )
